    ...
    <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-4">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="flex flex-col gap-3">
          <h1 className="text-5xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50 font-mono">{id}</h1>
          ...
          {derivedControls !== undefined && missingAnswers !== undefined && (
            ...
            >
              <div className="flex items-center gap-1.5">
                <span className="font-medium text-zinc-900 dark:text-zinc-50">{derivedControls}</span>
