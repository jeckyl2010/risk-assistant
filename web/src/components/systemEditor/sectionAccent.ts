...
export function sectionAccent(key: string): SectionAccent {
  const byKey: Record<string, SectionAccent> = {
    overview: {
      ...
      headerWrap: 'border-indigo-300 bg-gradient-to-br from-indigo-100 to-purple-100 dark:border-indigo-700 dark:from-indigo-900/50 dark:to-purple-900/50',
      headerChip:
    ...
    ai: {
      ...
      headerWrap: 'border-violet-300 bg-gradient-to-br from-violet-100 to-purple-100 dark:border-violet-700 dark:from-violet-900/50 dark:to-purple-900/50',
      headerChip:
    ...
    criticality: {
      ...
      headerWrap: 'border-amber-300 bg-gradient-to-br from-amber-100 to-orange-100 dark:border-amber-700 dark:from-amber-900/50 dark:to-orange-900/50',
      headerChip:
    ...
    data: {
      ...
      headerWrap: 'border-cyan-300 bg-gradient-to-br from-cyan-100 to-blue-100 dark:border-cyan-700 dark:from-cyan-900/50 dark:to-blue-900/50',
      headerChip:
    ...
    integration: {
      ...
      headerWrap: 'border-sky-300 bg-gradient-to-br from-sky-100 to-blue-100 dark:border-sky-700 dark:from-sky-900/50 dark:to-blue-900/50',
      headerChip:
    ...
    operations: {
      ...
      headerWrap: 'border-teal-300 bg-gradient-to-br from-teal-100 to-cyan-100 dark:border-teal-700 dark:from-teal-900/50 dark:to-cyan-900/50',
      headerChip:
    ...
    security: {
      ...
      headerWrap: 'border-rose-300 bg-gradient-to-br from-rose-100 to-pink-100 dark:border-rose-700 dark:from-rose-900/50 dark:to-pink-900/50',
      headerChip:
    ...
    cost: {
      ...
      headerWrap: 'border-lime-300 bg-gradient-to-br from-lime-100 to-green-100 dark:border-lime-700 dark:from-lime-900/50 dark:to-green-900/50',
      headerChip:
    ...
    results: {
      ...
      headerWrap: 'border-emerald-300 bg-gradient-to-br from-emerald-100 to-teal-100 dark:border-emerald-700 dark:from-emerald-900/50 dark:to-teal-900/50',
      headerChip:
    ...
    diff: {
      ...
      headerWrap: 'border-fuchsia-300 bg-gradient-to-br from-fuchsia-100 to-pink-100 dark:border-fuchsia-700 dark:from-fuchsia-900/50 dark:to-pink-900/50',
      headerChip:
