...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-lg bg-zinc-100 p-1 text-zinc-600 dark:bg-zinc-900 dark:text-zinc-400",
      className,
    )}
    {...props}
  />
